export const collaborativeData = {
  hero: {
    ...
    ctaButtons: ["Start Collaborative Partnership", "Apply as a Vendor", "Apply as a Buyer"],
  },
  whyCoreTrade: {
  ...
  eligibility: {
    ...
    standard: {
      ...
      vendors: "KPI 8+, Retention 6–18 months, prior experience in Core Trade or Brand Growth.",
      buyers: "KPI 7+, Retention 3–12 months, proven sourcing budget & prior engagement.",
  ...
  eligibilityTest: {
    ...
    vendorCriteria: "Tech adoption (AI/Blockchain), packaging infrastructure, previous co-design experience, retention history.",
    buyerCriteria: "Interest in storytelling/media, need for co-branded packaging, warehousing capability, retention history.",
    exampleOutput:
  ...
  tracks: [
    {
      ...
      retention: "6 months",
      bestFor: "Buyers who want unique product lines & vendors open to design innovation.",
    ...
    },
    {
      ...
      retention: "3 months",
      bestFor: "Brands, retailers, and vendors needing narrative-driven differentiation.",
      benefit: "Shared campaigns, digital content, AR/VR-enabled product stories.",
    ...
    },
    {
      ...
      retention: "12 months",
      bestFor: "Buyers seeking scalable distribution & vendors needing storage support.",
    ...
    },
    {
      ...
      bestFor: "Vendors upgrading to premium buyers; buyers requiring branded packaging.",
  ...
  journey: {
    ...
    steps: [
      ...
      {
        title: "Evaluation",
        description: "KPI evaluation + verification of prerequisite eligibility.",
      },
      {
        title: "Activation",
        description: "Access to collaborative services and tools (co-design, storytelling, warehousing, etc.).",
      },
      {
      ...
      {
        title: "Growth",
        description: "Progress to Institutional Partnerships (Museums, NGOs, Governments, Logistics, Tech).",
        pathways: [
  ...
  comparison: {
    ...
    standard: {
      ...
      features: [
        ...
        "Progress via KPI + retention (3–18 months).",
  ...
  faq: [
    {
      ...
      answer: "Only for the Technology Integration track. Others (Storytelling, Packaging, etc.) require mid-level readiness.",
    },
    {
