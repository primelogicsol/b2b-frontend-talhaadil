  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-16 pb-6">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[var(--primary-color)] mb-12 text-center">
          What Sets Us Apart
        </h2>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative order-1 lg:order-2">
              <div className="aspect-square rounded-2xl md:rounded-3xl overflow-hidden shadow-xl md:shadow-2xl">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="relative">
              <div className="aspect-[4/5] rounded-2xl md:rounded-3xl overflow-hidden shadow-xl md:shadow-2xl">
                <div className="w-full h-full bg-gradient-to-br from-blue-100 to-orange-100 flex items-center justify-center">
                  <div className="text-center p-6 md:p-8">
                    ...
                    <p className="text-gray-600 mt-2">Fayaz Ahmad Khan</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          <h2
            className="text-2xl md:text-3xl lg:text-4xl font-extrabold mb-12 md:mb-16"
            style={{ color: "var(--secondary-color)" }}
          >
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <div className="bg-white p-6 md:p-8 rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              <div
              ...
              <div className="aspect-[4/3] rounded-2xl md:rounded-3xl overflow-hidden shadow-xl md:shadow-2xl">
                <div className="w-full h-full bg-gradient-to-br from-orange-100 to-blue-100 flex items-center justify-center">
                  <div className="text-center p-6 md:p-8">
                    ...
                    <p className="text-gray-600 mt-2">Craftspeople at Work</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-700 mb-12 md:mb-16 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-12 md:mb-16">
            <div className="bg-gradient-to-br from-blue-50 to-orange-50 p-4 md:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <Target
                className="h-8 w-8 md:h-10 md:w-10 mx-auto mb-3 md:mb-4"
                style={{ color: "var(--secondary-color)" }}
              />
              <div
            ...
            <div className="bg-gradient-to-br from-orange-50 to-blue-50 p-4 md:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <Globe
                className="h-8 w-8 md:h-10 md:w-10 mx-auto mb-3 md:mb-4"
                style={{ color: "var(--primary-color)" }}
              />
