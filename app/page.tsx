        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <motion.button
                className={`w-full bg-[var(--secondary-color)] hover:bg-[var(--secondary-color)]/90 text-white font-semibold rounded-full transition-all duration-300 flex items-center justify-center gap-2 ${is4K ? 'py-6 text-xl' : 'py-4 text-lg'
                  }`}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
