    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-[var(--primary-color)]">All Notifications</h1>
            ...
            {loading ? (
                ...
                <div className="text-center py-12">
                    <div className="text-[var(--primary-hover-color)] mb-2">No notifications found</div>
                    <p className="text-sm text-[var(--secondary-color)]">You'll see notifications here when they're available</p>
                </div>
            ) : (
                <div className="space-y-4">
                    {notifications.map((notification, index) => {
                        const fakeDate = new Date(Date.now() - index * 86400000 - index * 3600000) // subtracts days & hours based on index
                        return (
                            <div
                                key={notification.id}
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                        ...
                                        <span className="text-xs text-[var(--primary-hover-color)]">
                                            {fakeDate.toLocaleDateString()} {fakeDate.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                                        </span>
                                    </div>
                                </div>
                            </div>
