...
export default function TeamCard({
  ...
  return (
    <div
      className={`relative ${
        isImportant ? (is4K ? "w-96" : "w-70") : is4K ? "w-80" : "w-60"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center h-full pt-12 pb-6 px-4 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400">
        ...
        <div className="relative">
          <div
            className={`${
              is4K ? "w-44 h-44" : "w-36 h-36"
            } rounded-full bg-gray-400 flex items-center justify-center overflow-hidden ring-4 ring-white/20 group-hover:ring-white/40 transition-all duration-500`}
          >
            <img
              src={imageUrl}
              alt={name}
        ...
        <div className="flex flex-col items-center text-center mt-8">
          <h3
            ...
            } font-bold text-slate-800 group-hover:text-gray-800 transition-all duration-500`}
          >
            {name}
          </h3>
          <p
        ...
        {isImportant && description && (
          <p
            ...
            } text-gray-700 text-center leading-snug transition-all duration-500`}
          >
            {description}
          </p>
        )}
        ...
        {isImportant && quote && (
          <blockquote
            ...
            } text-[var(--secondary-color)] group-hover:text-[var(--secondary-hover-color)] transition-all duration-500 text-center`}
          >
            “{quote}”
          </blockquote>
        )}
