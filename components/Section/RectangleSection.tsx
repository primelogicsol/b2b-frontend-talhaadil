...
Meet the people who are bringing this vision to life.`,
  ...
  return (
    <section className="relative py-12 md:py-24 lg:py-32 bg-white overflow-hidden px-4 sm:px-6 lg:px-8">
...
<div className="flex flex-col justify-center text-center lg:text-left mt-12 lg:mt-0 px-1 sm:px-0">
  ...
  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-6 text-[var(--primary-dark-slate)]">
    {title}{" "}
    <span className="text-[var(--secondary-color)]">{highlightedWords.one}</span> and{" "}
  ...
  <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-8 text-left">
    ...
    <div>
      <h3 className="text-center lg:text-left lg:-ml-14 text-lg sm:text-xl font-bold text-[var(--primary-dark-slate)] mb-2">
        {subTitle}
      </h3>
      <p className="text-sm sm:text-base text-[var(--primary-light-text-color)] max-w-2xl mx-auto lg:mx-0 text-left lg:text-center">
        {subDescription}
      </p>
    </div>
  </div>
