...
export default function AppointmentScheduler() {
  ...
  const getEffectiveCountry = (): "usa" | "india" | null => {
    ...
    if (formData.userType === "guest" && formData.guestCountry)
      return formData.guestCountry;
    return null;
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const body = {
      ...
      time_zone: getEffectiveTimeZone(),
      ...
      ...(formData.appointmentMode === "in-person" && {
        office_location: setOfficeByCountry(),
      }),
    };
  ...
  return (
    <div
      ...
      style={{
        margin: "0 auto",
        padding: is4K ? "32px" : "24px",
        fontSize: is4K ? "18px" : "16px",
      }}
    >
      {/* Header */}
      <div
        className="text-center mb-8"
        style={{ marginBottom: is4K ? "48px" : "32px" }}
      >
        <h1
          className={`font-bold text-[var(--primary-color)] mb-2 flex items-center justify-center ${
        ...
        <p
          className={`text-gray-600 mx-auto ${
            is4K ? "text-xl max-w-4xl" : "text-base max-w-2xl"
          }`}
        >
          Book a virtual or in-person meeting with our onboarding team, buyer
          advisors, or vendor support specialists all optimized for cross-border
          timing, calendars, and roles.
        </p>
      </div>
      ...
      <form
        ...
        className="space-y-8"
        style={{ gap: is4K ? "48px" : "32px" }}
      >
        {/* User Type Section */}
        <div
          className="bg-white rounded-lg shadow-lg"
          style={{ padding: is4K ? "48px" : "32px" }}
        >
          <h2
            className={`font-semibold text-[var(--primary-color)] mb-6 flex items-center ${
              is4K ? "text-3xl" : "text-xl"
            }`}
          ...
          <div className="space-y-4" style={{ gap: is4K ? "24px" : "16px" }}>
            {[
              ...
              >
                ...
                />
                <span
                  className={`font-medium ${is4K ? "text-xl" : "text-base"}`}
                >
                  {option.label}
                </span>
              </label>
        ...
        {formData.userType === "guest" && (
          ...
          >
            ...
            <p
              ...
              style={{ marginBottom: is4K ? "32px" : "24px" }}
            >
              Please let us know which country you're from to show appropriate
              time slots.
            </p>

            <div
              className="grid md:grid-cols-2"
              style={{ gap: is4K ? "32px" : "24px" }}
            >
              <label
                className={`flex items-center border-2 rounded-lg cursor-pointer transition-all ${
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    updateFormData("guestCountry", e.target.value)
                  }
                  className="mr-4 text-[var(--primary-color)] bg-gray-100 border-gray-300 focus:ring-[var(--primary-color)] focus:ring-2 accent-[var(--primary-color)]"
                  style={{
                    width: is4K ? "24px" : "20px",
              ...
              >
                ...
                >
                  <input
                    ...
                    onChange={() =>
                      updateFormData("appointmentMode", "virtual")
                    }
                    className="mr-4 text-[var(--primary-color)] bg-gray-100 border-gray-300 focus:ring-[var(--primary-color)] focus:ring-2 accent-[var(--primary-color)]"
                    style={{
                      width: is4K ? "24px" : "20px",
                  ...
                  />
                  <h3
                    className={`font-semibold ${is4K ? "text-2xl" : "text-lg"}`}
                  >
                    Virtual Meeting
                  </h3>
                </div>
                <p className={`text-gray-600 ${is4K ? "text-lg" : "text-sm"}`}>
              ...
              >
                ...
                >
                  <input
                    ...
                    onChange={() =>
                      updateFormData("appointmentMode", "in-person")
                    }
                    className="mr-4 text-[var(--primary-color)] bg-gray-100 border-gray-300 focus:ring-[var(--primary-color)] focus:ring-2 accent-[var(--primary-color)]"
                    style={{
                      width: is4K ? "24px" : "20px",
        ...
        {formData.appointmentMode === "in-person" &&
          getFilteredOffices().length > 0 && (
            <div
              className="bg-white rounded-lg shadow-lg"
              style={{ padding: is4K ? "24px 48px" : "16px 32px" }}
            >
              <h2
                className={`font-semibold text-[var(--primary-color)] mb-6 flex items-center ${
                  is4K ? "text-3xl" : "text-xl"
                ...
                <table className="w-full border-collapse rounded-lg overflow-hidden shadow-sm">
                  <thead>
                    <tr className="bg-[var(--primary-color)] text-white">
                      <th
                        className={`border border-[var(--primary-hover-color)] text-left font-semibold ${
                          is4K ? "text-xl p-6" : "text-base p-4"
                        }`}
                      >
                        Office
                      </th>
                      ...
                      >
                        <td
                          className={`border border-gray-200 font-medium ${
                            is4K ? "text-lg p-6" : "text-base p-4"
                          }`}
                        >
                        ...
                        <td
                          className={`border border-gray-200 text-gray-700 ${
                            is4K ? "text-lg p-6" : "text-sm p-4"
                          }`}
                        >
                          {office.address}
                        </td>
                        <td
                          className={`border border-gray-200 text-gray-700 font-mono ${
                            is4K ? "text-lg p-6" : "text-sm p-4"
                          }`}
                        >
                          {office.phone}
                ...
                {getFilteredOffices().map((office) => (
                  ...
                  >
                    <div
                      ...
                      style={{ marginBottom: is4K ? "18px" : "12px" }}
                    >
                    ...
                    <div
                      className={`space-y-2 ${is4K ? "text-lg" : "text-sm"}`}
                      style={{ gap: is4K ? "12px" : "8px" }}
                    >
                      <div className="flex items-start">
                        <span
                          className={`font-medium text-gray-600 flex-shrink-0 ${
                            is4K ? "w-20" : "w-16"
                          }`}
                        >
                          Address:
          ...
          >
            ...
            >
              ...
              <div>
                <label
                  className={`block font-medium text-gray-700 ${
                    is4K ? "text-xl mb-6" : "text-sm mb-4"
                  }`}
                >
              ...
              <div>
                ...
                {formData.date ? (
                  ...
                  <div
                    className={`border border-gray-200 rounded-lg text-center text-gray-500 ${
                      is4K ? "text-lg p-6" : "text-base p-4"
                    }`}
                  >
            ...
            {availableTimeSlots.length > 0 && (
              <div
                ...
                style={{
                  marginTop: is4K ? "24px" : "16px",
                  padding: is4K ? "24px" : "16px",
                }}
              >
                <p
                ...
                >
                  <strong>Note:</strong> All times are shown in{" "}
                  {availableTimeSlots[0]?.timezone} timezone.
                  {getEffectiveCountry() === "usa" &&
                    " (Eastern Standard Time)"}
                  {getEffectiveCountry() === "india" &&
                    " (India Standard Time)"}
                </p>
              </div>
            )}
          ...
          >
            ...
            <div className="space-y-4" style={{ gap: is4K ? "24px" : "16px" }}>
              <select
                ...
                className={`w-full border border-gray-300 rounded-lg custom-select focus:ring-2 focus:ring-[var(--primary-color)] focus:border-transparent ${
                  is4K ? "text-lg p-4" : "text-base p-3"
                }`}
                required
              >
            ...
            >
              <div>
                ...
                <input
                  ...
                  className={`w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--primary-color)] focus:border-transparent ${
                    is4K ? "text-lg p-4" : "text-base p-3"
                  }`}
                  required
                />
            ...
            <div style={{ marginTop: is4K ? "32px" : "24px" }}>
              <label className="flex items-start">
                <input
                  ...
                  onChange={(e) =>
                    updateFormData("authorized", e.target.checked)
                  }
        ...
        {formData.authorized && (
          ...
          >
            <button
              ...
              className={`w-full bg-[var(--primary-color)] hover:bg-[var(--primary-hover-color)] text-white font-semibold rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center ${
                is4K ? "text-2xl py-6 px-8" : "text-lg py-4 px-6"
              }`}
            >
              <CheckCircle
                className="mr-3"
    ...
    >
      ...
      >
          ...
          >
            ...
            <div>
              ...
              <p className={is4K ? "text-lg" : "text-base"}>
                {formData.appointmentMode === "virtual"
                  ? "Virtual Meeting"
                  : `In-Person at ${setOfficeByCountry()}`}
              </p>
            </div>
            <div>
              <p
        ...
        <div style={{ marginBottom: is4K ? "48px" : "32px" }}>
          <p
            className={`text-gray-600 mb-4 flex items-center justify-center ${
              is4K ? "text-xl" : "text-base"
            }`}
            style={{ marginBottom: is4K ? "24px" : "16px" }}
          >
        ...
        >
          <h3
            className={`font-semibold text-[var(--secondary-color)] mb-4 flex items-center justify-center ${
              is4K ? "text-2xl" : "text-lg"
            }`}
            style={{ marginBottom: is4K ? "24px" : "16px" }}
          >
          ...
          <p
            ...
            style={{ marginBottom: is4K ? "24px" : "16px" }}
          >
            Please complete your business registration before your appointment
            date. This ensures smoother onboarding, document access, and profile
            validation.
          </p>
          ...
          >
            <button
              ...
              className={`bg-[var(--primary-color)] hover:bg-[var(--primary-hover-color)] text-white rounded-lg font-semibold flex items-center justify-center ${
                is4K ? "text-xl px-8 py-4" : "text-base px-6 py-3"
              }`}
            >
              <User
                className="mr-2"
        ...
        <div
          ...
          style={{
            marginTop: is4K ? "48px" : "32px",
            padding: is4K ? "32px" : "24px",
          }}
        >
          <h4
            className={`font-semibold text-[var(--primary-color)] mb-2 flex items-center justify-center ${
              is4K ? "text-2xl" : "text-lg"
            }`}
            style={{ marginBottom: is4K ? "16px" : "8px" }}
          >
          ...
          <button
            ...
            className={`bg-[var(--primary-color)] hover:bg-[var(--primary-hover-color)] text-white rounded-lg font-semibold flex items-center justify-center mx-auto ${
              is4K ? "text-xl px-10 py-4" : "text-base px-8 py-3"
            }`}
          >
            <User
              className="mr-2"
