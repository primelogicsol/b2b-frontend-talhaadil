...
export default function InsidePage({
  ...
  const isSlideUpInView = useInView(slideUpRef, {
    once: true,
    margin: "-100px",
  });
  ...
  useEffect(() => {
    async function getPartnershipPrices() {
      ...
      const pricing = matchedItem
        ? convertKeysToNumbers(matchedItem.prices)
        : fallbackPricing;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      >
        ...
        >
          <div className="text-center space-y-8">
            <motion.h1
              className={`${headingClass} font-bold leading-tight`}
              variants={fadeInUp}
            >
      ...
      >
        <div className="grid md:grid-cols-2 gap-12 items-stretch">
          ...
          <motion.div
            ...
            variants={fadeInUp}
          >
            <div className="rounded-2xl shadow-lg overflow-hidden w-full max-w-md h-full">
              <video
          ...
          >
            ...
            <div>
              ...
              <div className="space-y-4">
                {landingPageData.whyDropshipping.problems.map(
                  (problem, index) => (
                    <motion.div
                      key={index}
            ...
            <div>
              ...
              <div className="space-y-4">
                {landingPageData.whyDropshipping.solutions.map(
                  (solution, index) => (
                    <motion.div
                      key={index}
                      className="flex items-start gap-3"
      ...
      {landingPageData.technology && (
        ...
        >
          <div className={`${containerClass} mx-auto px-6`}>
            <motion.h2
              className={`${subHeadingClass} font-bold text-center mb-8 text-2xl md:text-3xl lg:text-4xl`}
              variants={fadeInUp}
            >
            ...
            <motion.div className="text-center" variants={fadeInUp}>
              <p className={`${is4K ? "text-lg" : "text-base"} text-white`}>
                {landingPageData.technology.support}
              </p>
            </motion.div>
          </div>
        </motion.section>
        ...
        >
          <div className="relative z-10">
            ...
            <div className="space-y-8">
              {landingPageData.platformAdvantage.sections.map(
                (section, index) => (
                  <motion.div
                    key={index}
        ...
        <div className="w-full max-w-4xl mx-auto p-6 md:p-8">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--primary-color)] mb-4">
              {landingPageData.workflow.heading}
            </h2>
          ...
          <div className="relative z-10 justify-between items-start hidden md:flex">
            ...
            <div className="absolute top-12 left-12 right-12 h-1 bg-[var(--secondary-light-color)] z-0">
              <div className="h-full bg-[var(--secondary-color)] rounded-full"></div>
            </div>
