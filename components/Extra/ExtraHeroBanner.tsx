...
export default function HeroBanner() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[var(--softtec-blue)] flex items-center justify-center py-16 px-4 md:px-8 lg:px-16">
      ...
      /> */}
      <img
        src="/images/hero-4-3.png"
        alt="Background pattern"
        className="absolute inset-0 w-full h-full object-contain opacity-100 right-20 animate-spin [animation-duration:40s] [animation-timing-function:linear]"
      />
      {/* Concentric Circles */}
