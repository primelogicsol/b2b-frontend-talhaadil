...
export default function CostComparisonResponsive({
  costComparison,
}: CostComparisonResponsiveProps) {
  ...
  const platformKeys =
    costComparison.length > 0 ? Object.keys(costComparison[0].platforms) : [];
  const platforms =
    costComparison.length > 0 ? Object.values(costComparison[0].platforms) : [];
                      ...
                      <td
                        ...
                        className={`px-6 py-2 text-center text-sm transition-colors duration-200 border border-white ${
                          platform.isOurPlatform
                            ? "font-bold bg-[var(--primary-color)] text-white"
                            : "bg-gray-300"
                        }`}
                      >
                        {platform.value}
      ...
      <div className="hidden md:block xl:hidden">
        <div className="grid grid-cols-2 gap-6">
          {costComparison.map((row, index) => (
            ...
            >
              <h3 className="font-bold text-xl text-[var(--primary-color)] mb-4 text-center">
                {row.feature}
              </h3>
          ...
          <div className="space-y-4 mb-6">
            {getCurrentCards().map((row, index) => {
              ...
              return (
                ...
                >
                  <h3 className="font-bold text-lg text-[var(--primary-color)] mb-3 text-center">
                    {row.feature}
                  </h3>
                      ...
                      return (
                        <div
                          ...
                          className={`flex justify-between items-center p-2 ${
                            platform.isOurPlatform
                              ? "bg-[var(--primary-header-color)] rounded-md"
                              : ""
                          }`}
                        >
                          <span
