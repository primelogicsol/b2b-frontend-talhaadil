...
export default function EthicalSourcingSustainability() {
  ...
  const testimonials = [
    {
      ...
      quote:
        "De Koshur Crafts has transformed my business. The fair wages and sustainable practices have allowed me to expand my workshop while preserving our traditional methods.",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=80&width=80",
      quote:
        "The training on eco-friendly materials has helped me create better products while protecting our environment. My family's future looks brighter now.",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=80&width=80",
      quote:
        "Working with De Koshur Crafts means I can focus on my art while knowing I'm contributing to a sustainable future for my community.",
  ...
  const sustainabilityPractices = [
    {
      ...
      description: "Natural fibers, organic dyes, and sustainable materials in all products",
      percentage: 92,
    ...
    },
    {
      ...
      description: "Utilizing every scrap of material to minimize environmental impact",
      percentage: 88,
      color: "from-[var(--secondary-hover-color)] to-[var(--secondary-color)]",
    },
    {
      ...
      description: "Repurposing materials to contribute to the circular economy",
      percentage: 95,
      color: "from-[var(--secondary-hover-color)] to-[var(--secondary-color)]",
    },
    {
      ...
      description: "Recycled materials and innovative eco‑friendly packaging options",
      percentage: 78,
      color: "from-[var(--secondary-hover-color)] to-[var(--secondary-color)]",
    },
  ]
  ...
  const testimonialIsInViews = testimonials.map(() => false)
  const testimonialCounts = testimonials.map(() => 0)

  const testimonialSectionRef = useRef<HTMLDivElement | null>(null)
  const isInView = useInView(testimonialSectionRef, { amount: 0.3 })
  ...
  useEffect(() => {
    testimonials.forEach((_, index) => {
      const ref = testimonialRefs.current[index]
      if (ref) {
        testimonialIsInViews[index] = isInView
        if (isInView) {
          let start = testimonialCounts[index]
          const timer = setInterval(() => {
            start += 1
            testimonialCounts[index] = start
            if (start >= sustainabilityPractices[index].percentage) clearInterval(timer)
          }, 15)
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      >
        ...
        <div className={`text-center relative z-10 mx-auto ${is4K ? "max-w-[1800px]" : "max-w-6xl"}`}>
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Crafting a <span className="text-[var(--primary-hover-color)]">Better Future</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-500 max-w-4xl mx-auto leading-relaxed mb-8">
            At De Koshur Crafts, we are committed to ethically sourcing products and ensuring that our entire supply
            chain is sustainable, from raw materials to the finished product.
          </p>
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-6 mb-8 max-w-md mx-auto">
            ...
            <p className="text-[var(--primary-light-text-color)]">{heroImages[currentSlide].description}</p>
          </div>
            ...
            {heroImages.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${
                  index === currentSlide ? "bg-[var(--secondary-hover-color)] scale-125" : "bg-white bg-opacity-50"
                }`}
              />
            ))}
          </div>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-[var(--primary-color)] hover:bg-[#2a5f7a] text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg">
              Learn More
            </button>
            <button className="border-2 border-white text-white hover:bg-white hover:text-[#1b4f68] px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105">
              Our Impact
            </button>
          </div>
        </div>
      ...
      <section className={`scroll-section text-[var(--primary-hover-color)] ${is4K ? "py-24 px-20" : "py-16 px-4"}`}>
        <div className={`mx-auto ${is4K ? "max-w-[1800px]" : "max-w-6xl"}`}>
          <div className="text-center mb-12">
            <h2 className={`font-bold mb-4 ${is4K ? "text-5xl" : "text-3xl md:text-4xl"}`}>
              Our <span className="text-[var(--secondary-color)]">Impact</span> in Numbers
            </h2>
          </div>
          <div className="grid md:grid-cols-4 gap-8">
            {sustainabilityStats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-4xl font-bold text-[var(--secondary-hover-color)] mb-2">{stat.value}</div>
      ...
      <section className={`scroll-section ${is4K ? "py-28 px-20" : "py-20 px-4"}`}>
        <div className={`mx-auto ${is4K ? "max-w-[1800px]" : "max-w-6xl"}`}>
          <div className="text-center mb-16">
            <h2 className={`font-bold text-[#0f172a] mb-4 ${is4K ? "text-5xl" : "text-3xl md:text-4xl"}`}>
              Our Commitment to <span className="text-[var(--secondary-color)]">Ethical Sourcing</span>
            </h2>
            <p className={`text-gray-600 max-w-3xl mx-auto ${is4K ? "text-xl" : "text-lg"}`}>
              Every product is carefully vetted for its origin, materials, and crafting process to ensure it meets our
              ethical standards.
            </p>
          </div>
      ...
      >
        ...
        <div className={`mx-auto ${is4K ? "max-w-[1800px]" : "max-w-6xl"}`}>
          <div className="text-center mb-16">
            <h2 className={`font-bold text-[#0f172a] mb-4 ${is4K ? "text-5xl" : "text-3xl md:text-4xl"}`}>
              Sustainability: <span className="text-[var(--secondary-color)]">Protecting Our Planet</span>
            </h2>
            <p className={`text-gray-600 max-w-3xl mx-auto ${is4K ? "text-xl" : "text-lg"}`}>
              Building a business model that benefits artisans while supporting long-term environmental responsibility.
            </p>
          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                      <motion.div
                        ...
                        initial={{ width: "0%" }}
                        animate={{
                          width: testimonialIsInViews[index] ? `${practice.percentage}%` : "0%",
                        }}
          ...
          <div className="bg-gradient-to-r from-[var(--primary-color)] to-[var(--primary-hover-color)] rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className={`font-bold ${is4K ? "text-5xl" : "text-2xl md:text-3xl"}`}>
                  Carbon Footprint Reduction
                </h3>
              </div>
              <p className={`opacity-90 mb-8 max-w-3xl ${is4K ? "text-xl" : "text-lg"}`}>
                We implement energy-efficient practices, promote carbon-neutral shipping options, and partner with
                logistics companies that prioritize sustainability.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={`mx-auto ${is4K ? "max-w-[1800px]" : "max-w-6xl"}`}>
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0f172a] mb-4">
              Voices from Our <span className="text-[var(--secondary-color)]">Artisan Community</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Hear directly from the artisans whose lives have been transformed through sustainable practices.
            </p>
          </div>
          <div className="relative">
                    ...
                    <div className="bg-gradient-to-br rounded-3xl p-8 md:p-12 shadow-2xl max-w-4xl mx-auto">
                      <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="flex-1 text-center md:text-left">
                          ...
                          <div>
                            <div className="font-bold text-xl text-[#0f172a]">{testimonial.name}</div>
                            <div className="text-[var(--secondary-color)] font-semibold">{testimonial.craft}</div>
            ...
            <div className="flex justify-center gap-4 mt-8">
              <button
                onClick={() => prevSlide(testimonialSlide, testimonials.length, setTestimonialSlide)}
              ...
              <div className="flex gap-2 items-center">
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      index === testimonialSlide ? "bg-[#d85834] scale-125" : "bg-gray-300"
                    }`}
                  />
                ))}
              </div>
              <button
                onClick={() => nextSlide(testimonialSlide, testimonials.length, setTestimonialSlide)}
                className="bg-[var(--secondary-color)] hover:bg-[var(--secondary-hover-color)] text-white p-3 rounded-full transition-all duration-300 hover:scale-110"
              >
      ...
      <section className={`scroll-section ${is4K ? "py-28 px-20" : "py-20 px-4"} text-gray-900`}>
        <div className={`mx-auto ${is4K ? "max-w-[1800px]" : "max-w-6xl"}`}>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className={`font-bold mb-6 ${is4K ? "text-5xl" : "text-3xl md:text-4xl"}`}>
                Our Promise to <span className="text-[var(--primary-color)]">Kashmir</span>
              </h2>
              <p className={`opacity-90 mb-8 leading-relaxed ${is4K ? "text-xl" : "text-lg"}`}>
                Every dollar earned through B2B Connect drives initiatives back to the valley:
              </p>
              ...
              <p className={`opacity-90 mt-8 leading-relaxed ${is4K ? "text-xl" : "text-lg"}`}>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[var(--primary-light-text-color)] to-[var(--primary-color)] rounded-3xl p-8 transform hover:scale-105 transition-transform duration-500 relative overflow-hidden">
                ...
                <h3 className={`font-bold text-white mb-4 ${is4K ? "text-3xl" : "text-2xl"}`}>Impact That Matters</h3>
                <p className={`text-white opacity-90 leading-relaxed ${is4K ? "text-lg" : ""}`}>
                 Every initiative we undertake directly uplifts local artisans, safeguards centuries-old cultural heritage, and drives long-term, sustainable development—ensuring a resilient and thriving future for the valley and its communities.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className={`scroll-section ${is4K ? "py-28 px-20" : "py-20 px-4"}`}>
        <div className={`mx-auto ${is4K ? "max-w-[1800px]" : "max-w-6xl"}`}>
          <div className="text-center mb-16">
            <h2 className={`font-bold text-[#0f172a] mb-4 ${is4K ? "text-5xl" : "text-3xl md:text-4xl"}`}>
              Our Future: <span className="text-[#1b4f68]">Growing Sustainably</span>
            </h2>
            <p className={`text-gray-600 max-w-3xl mx-auto ${is4K ? "text-xl" : "text-lg"}`}>
              We are excited about continued growth and the positive impact we can make on the world.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Helping more artisans adopt green practices in their production processes",
                color: "from-[var(--primary-color)] to-[var(--primary-hover-color)]",
                icon: TrendingUp,
              },
              {
                title: "Global Impact",
                description: "Connecting more buyers with artisans who prioritize sustainability",
                color: "from-[var(--primary-color)] to-[var(--primary-hover-color)]",
                icon: Globe,
              },
              {
                title: "Environmental Care",
                description: "Minimizing carbon footprint with like-minded partners",
                color: "from-[var(--primary-color)] to-[var(--primary-hover-color)]",
                icon: Leaf,
              },
            ].map((goal, index) => (
              ...
              >
                ...
                <p className={`text-gray-600 leading-relaxed ${is4K ? "text-lg" : ""}`}>{goal.description}</p>
              </div>
            ))}
          </div>
        </div>
