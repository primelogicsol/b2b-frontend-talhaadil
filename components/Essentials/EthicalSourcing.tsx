...
export default function EthicalSourcingSustainability() {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section
        className={`scroll-section relative overflow-hidden py-20 px-4 transition-all duration-1000 ${
      ...
      <section className="scroll-section py-16 px-4 text-[var(--primary-hover-color)]">
      ...
      {/* Ethical Sourcing Principles with Enhanced Cards */}
      ...
      <section className="scroll-section py-20 px-4 bg-gradient-to-r from-[#e4e6eb] to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0f172a] mb-4">
              Sustainability:{" "}
